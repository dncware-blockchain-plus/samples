...
export class ReserveTransferButtonScreenComponentBase extends ScreenComponentBase {
    constructor() {
        super();
    ...
    async updateTransferButton() {
        ...
        // 転送予約ボタンの表示名を特定する。
        this.buttonText = this.isButtonDisabled ? '転送予約中...' : '転送を予約';

        // 転送予約ボタンの表示状態を更新する。
        const transferButton = document.getElementById('reserve-transfer-button');
